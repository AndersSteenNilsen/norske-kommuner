...
kommuner_pydantic = [
    FylkerKommunerFull.model_construct(**i) for i in json.loads(raw_json)
]
kommuner_flat = [
    KommuneWithOrg.model_construct(**k)
    for fylke in kommuner_pydantic
    for k in fylke.kommuner
]
